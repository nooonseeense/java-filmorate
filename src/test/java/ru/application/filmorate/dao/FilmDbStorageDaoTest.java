...
//                .build();
//
//        Film filmInDb = filmDbStorageDao.getById(filmExpected.getId());
//
...
//                .build();
//
//        Film actualFilm = filmDbStorageDao.add(film);
//
...
//                .build();
//
//        filmDbStorageDao.update(filmExpected);
//        Film actualFilm = filmDbStorageDao.getById(filmExpected.getId());
//
//        assertEquals(filmExpected.getId(), actualFilm.getId());
//        assertEquals(filmExpected.getName(), actualFilm.getName());
//        assertEquals(filmExpected.getDescription(), actualFilm.getDescription());
